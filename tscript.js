...
function fetchAndSortByPrice(category, sort) {
    const apiUrl = category === 'home' ? 'https://fakestoreapi.com/products' : `https://fakestoreapi.com/products/category/${category}`;
    fetch(apiUrl)
        .then((res) => res.json())
        .then((json) => {
...
function fetchAndSortByRating(category, sort) {
    const apiUrl = category === 'home' ? 'https://fakestoreapi.com/products' : `https://fakestoreapi.com/products/category/${category}`;
    fetch(apiUrl)
        .then((res) => res.json())
        .then((json) => {
...
function fetchAndFilterByRating(category, filter) {
    const apiUrl = category === 'home' ? 'https://fakestoreapi.com/products' : `https://fakestoreapi.com/products/category/${category}`;
    fetch(apiUrl)
        .then((res) => res.json())
        .then((json) => {
...
`;
    ...
    if (topContainer) {
        ...
        const sortPriceLow = document.querySelector("#sortByPriceLow");
        ...
        const sortPriceHigh = document.querySelector("#sortByPriceHigh");
        ...
        const sortRatingLow = document.querySelector("#sortByRatingLow");
        ...
        const sortRatingHigh = document.querySelector("#sortByRatingHigh");
        ...
        const filterRating4 = document.querySelector("#filterBy4");
        ...
        const filterRating3 = document.querySelector("#filterBy3");
        ...
        const filterRating2 = document.querySelector("#filterBy2");
